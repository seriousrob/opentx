...
class BlackTheme: public Theme
{
  public:
    ...
    void loadColors() const
    {
      ...
      lcdColorTable[TEXT_BGCOLOR_INDEX] = RGB(20, 20, 20);//(10, 78, 121)
      lcdColorTable[TEXT_INVERTED_COLOR_INDEX] = WHITE;
      lcdColorTable[TEXT_INVERTED_BGCOLOR_INDEX] = RGB(10, 10, 10);//(32, 34, 42)
      ...
      lcdColorTable[MENU_TITLE_DISABLE_COLOR_INDEX] = GREY;
      lcdColorTable[HEADER_COLOR_INDEX] = RGB(10, 10, 10);//(32, 34, 42)
      lcdColorTable[ALARM_COLOR_INDEX] = RGB(80,0,0);//(32, 34, 42)
      ...
      lcdColorTable[CURVE_COLOR_INDEX] = RGB(10, 10, 10);//(32, 34, 42)
      lcdColorTable[CURVE_CURSOR_COLOR_INDEX] = RGB(10, 10, 10);//(32, 34, 42)
      lcdColorTable[TITLE_BGCOLOR_INDEX] =RGB(10, 10, 10);//(32, 34, 42)
      lcdColorTable[TRIM_BGCOLOR_INDEX] = RGB(10, 10, 10);//(32, 34, 42)
      ...
      lcdColorTable[HEADER_CURRENT_BGCOLOR_INDEX] = RGB(20, 20, 20);//(10, 78, 121)
      lcdColorTable[OVERLAY_COLOR_INDEX] = BLACK;
      lcdColorTable[BARGRAPH1_COLOR_INDEX] = RGB(80,80,80);//(15, 150, 250)
      lcdColorTable[BARGRAPH2_COLOR_INDEX] = RGB(167, 167, 167);
      lcdColorTable[BARGRAPH_BGCOLOR_INDEX] = RGB(100,100,100);//(97, 97, 102)
    }
...
BitmapBuffer * BlackTheme::menuIconNormal[MENUS_ICONS_COUNT] = { NULL };
BitmapBuffer * BlackTheme::menuIconSelected[MENUS_ICONS_COUNT] = { NULL };

const BlackTheme blackTheme;
